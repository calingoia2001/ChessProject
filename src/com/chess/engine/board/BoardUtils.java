...
public class BoardUtils {
    ...
    public static final Map<String, Integer> POSITION_TO_COORDINATE = initializePositionToCoordianteMap();
    ...
    private static Map<String, Integer> initializePositionToCoordianteMap() {
